...
public class DocRule {
    ...
    private int copies;
    private int countryArrId;
    private int countryDepId;
    private int crewRouteCategoryId;
    private String crewType;
    private String dateEnd; //"2023-07-21T05:01:55.135"
    ...
    private String modifyDate; //"2023-07-28T10:51:21.087"
